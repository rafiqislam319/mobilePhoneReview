                            ...
                            <ul class="slides">
                                <li data-thumb="{{asset('/')}}/front-end/images/si1.jpg">
                                    <div class="thumb-image">
                                        <img src="{{asset('/')}}/front-end/images/si1.jpg" data-imagezoom="true" class="img-fluid" alt=""> </div>
                                </li>
                                <li data-thumb="{{asset('/')}}/front-end/images/si2.jpg">
                                    <div class="thumb-image">
                                        <img src="{{asset('/')}}/front-end/images/si2.jpg" data-imagezoom="true" class="img-fluid" alt=""> </div>
                                </li>
                                <li data-thumb="{{asset('/')}}/front-end/images/si3.jpg">
                                    <div class="thumb-image">
                                        <img src="{{asset('/')}}/front-end/images/si3.jpg" data-imagezoom="true" class="img-fluid" alt=""> </div>
                                </li>
                            </ul>
